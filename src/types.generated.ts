...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  getCityDistanceUsingGET?: Resolver<Maybe<ResolversTypes['DistanceResponse']>, ParentType, ContextType, RequireFields<QueryGetCityDistanceUsingGetArgs, 'cityId' | 'toCityId'>>;
  getCityLocatedInUsingGET?: Resolver<Maybe<ResolversTypes['PopulatedPlaceResponse']>, ParentType, ContextType, RequireFields<QueryGetCityLocatedInUsingGetArgs, 'cityId'>>;
  ...
  getCurrenciesUsingGET?: Resolver<Maybe<ResolversTypes['CurrenciesResponse']>, ParentType, ContextType, RequireFields<QueryGetCurrenciesUsingGetArgs, 'countryId'>>;
...
export type OpenBrewerySdk = {
  breweries: (args: QueryBreweriesArgs, projectionOptions?: ProjectionOptions) => Promise<Query['breweries']>
};

export type QueryOpenBrewerySdk = {
  breweries: (args: QueryBreweriesArgs, projectionOptions?: ProjectionOptions) => Promise<Query['breweries']>
};

export type MutationOpenBrewerySdk = {

};

export type SubscriptionOpenBrewerySdk = {

};

export type GeoDbSdk = {
  findAdminDivisionsUsingGET: (args: QueryFindAdminDivisionsUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findAdminDivisionsUsingGET']>,
  findCitiesNearAdminDivisionUsingGET: (args: QueryFindCitiesNearAdminDivisionUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findCitiesNearAdminDivisionUsingGET']>,
  findCitiesNearCityUsingGET: (args: QueryFindCitiesNearCityUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findCitiesNearCityUsingGET']>,
  findCitiesNearLocationUsingGET: (args: QueryFindCitiesNearLocationUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findCitiesNearLocationUsingGET']>,
  findCitiesUsingGET: (args: QueryFindCitiesUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findCitiesUsingGET']>,
  findDivisionsNearAdminDivisionUsingGET: (args: QueryFindDivisionsNearAdminDivisionUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findDivisionsNearAdminDivisionUsingGET']>,
  findDivisionsNearLocationUsingGET: (args: QueryFindDivisionsNearLocationUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findDivisionsNearLocationUsingGET']>,
  findRegionCitiesUsingGET: (args: QueryFindRegionCitiesUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findRegionCitiesUsingGET']>,
  findRegionDivisionsUsingGET: (args: QueryFindRegionDivisionsUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findRegionDivisionsUsingGET']>,
  getAdminDivisionUsingGET: (args: QueryGetAdminDivisionUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getAdminDivisionUsingGET']>,
  getCityDateTimeUsingGET: (args: QueryGetCityDateTimeUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getCityDateTimeUsingGET']>,
  getCityDistanceUsingGET: (args: QueryGetCityDistanceUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getCityDistanceUsingGET']>,
  getCityLocatedInUsingGET: (args: QueryGetCityLocatedInUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getCityLocatedInUsingGET']>,
  getCityTimeUsingGET: (args: QueryGetCityTimeUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getCityTimeUsingGET']>,
  getCityUsingGET: (args: QueryGetCityUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getCityUsingGET']>,
  getCountriesUsingGET: (args: QueryGetCountriesUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getCountriesUsingGET']>,
  getCountryUsingGET: (args: QueryGetCountryUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getCountryUsingGET']>,
  getCurrenciesUsingGET: (args: QueryGetCurrenciesUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getCurrenciesUsingGET']>,
  getLanguagesUsingGET: (args: QueryGetLanguagesUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getLanguagesUsingGET']>,
  getLocalesUsingGET: (args: QueryGetLocalesUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getLocalesUsingGET']>,
  getRegionUsingGET: (args: QueryGetRegionUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getRegionUsingGET']>,
  getRegionsUsingGET: (args: QueryGetRegionsUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getRegionsUsingGET']>,
  getTimeZoneDateTimeUsingGET: (args: QueryGetTimeZoneDateTimeUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getTimeZoneDateTimeUsingGET']>,
  getTimeZoneTimeUsingGET: (args: QueryGetTimeZoneTimeUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getTimeZoneTimeUsingGET']>,
  getTimezonesUsingGET: (args: QueryGetTimezonesUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['getTimezonesUsingGET']>
};

export type QueryGeoDbSdk = {
  findAdminDivisionsUsingGET: (args: QueryFindAdminDivisionsUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findAdminDivisionsUsingGET']>,
  findCitiesNearAdminDivisionUsingGET: (args: QueryFindCitiesNearAdminDivisionUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findCitiesNearAdminDivisionUsingGET']>,
  findCitiesNearCityUsingGET: (args: QueryFindCitiesNearCityUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findCitiesNearCityUsingGET']>,
  findCitiesNearLocationUsingGET: (args: QueryFindCitiesNearLocationUsingGetArgs, projectionOptions?: ProjectionOptions) => Promise<Query['findCitiesNearLocationUsingGET']>,
...
export type MutationGeoDbSdk = {

};

export type SubscriptionGeoDbSdk = {

};

export type OpenBreweryContext = { 
      ["OpenBrewery"]: { api: OpenBrewerySdk, apiQuery: QueryOpenBrewerySdk, apiMutation: MutationOpenBrewerySdk, apiSubscription: SubscriptionOpenBrewerySdk }, 
    };

export type GeoDbContext = { 
      ["GeoDB"]: { api: GeoDbSdk, apiQuery: QueryGeoDbSdk, apiMutation: MutationGeoDbSdk, apiSubscription: SubscriptionGeoDbSdk }, 
    };

export type MeshContext = OpenBreweryContext & GeoDbContext & BaseMeshContext;